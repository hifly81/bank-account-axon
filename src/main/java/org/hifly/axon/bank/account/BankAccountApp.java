...
import org.hifly.axon.bank.account.config.AxonConfig;
import org.hifly.axon.bank.account.config.KafkaConfig;
...
public class BankAccountApp {
    ...
    public static void main(String[] args) {
        ...
        KafkaPublisher<String, byte[]> kafkaPublisher =  KafkaConfig.createPublisher(eventBus, "axon");
        ...
        KafkaPublisher<String, byte[]> kafkaEventStorePublisher =  KafkaConfig.createPublisher(eventStore, "axon");
        ...
        kafkaEventStorePublisher.shutDown();
